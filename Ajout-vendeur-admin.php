...
{ 
	...
	//move_uploaded_file renvoi true si ca a fonctionné
     ...
     {
          echo 'Echec du telechargement de la photo <br> !';
     }
}
...
<html> 
	<head> 
		<meta charset="utf-8"> 
		<title>Ajout de Vendeur - ECE Amazon</title> 
			...
			<div class="container-fluid">
				...
				<div class="row">
                  <div class="form-group">
                   <label for="pseudo" class="col-sm-3 control-label">Pseudo : </label>
                     <div class="col-sm-9">
                      <input name ="pseudo" placeholder="Pseudo" type="text" class="form-control"required>
                     </div>
                  </div>
		        </div>
					...
					<div class="row">
                      ...
                      <div class="col-sm-9">
                       <input name ="mdp" placeholder="Mot de passe" type="password" class="form-control"required>
                     </div>
                     </div>
		            </div>
				...
				<!-- Photo-->
				  ...
				  <div class="form-group">
                   ...
                   <input type="submit" class="pull-right btn btn-default" name="envoie_form_compte_vendeur" value="Creer un compte vendeur"/>
                    </div> 
					</div>
					</div>
